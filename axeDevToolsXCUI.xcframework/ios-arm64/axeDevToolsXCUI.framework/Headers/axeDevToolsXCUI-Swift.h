...
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
- (BOOL)enableWithBundleId:(NSString * _Nonnull)bundleId apiKey:(NSString * _Nonnull)apiKey axeServiceUrl:(NSString * _Nonnull)axeServiceUrl projectId:(NSString * _Nonnull)projectId uploadToDashboard:(BOOL)uploadToDashboard error:(NSError * _Nullable * _Nullable)error;
