...
The Axe DevTools Mobile SDK for iOS helps you integrate mobile accessibility testing with your automated tests, to catch accessibility defects before they make it to production.
...
To use Axe DevTools, you must be a current Deque customer.
<!-- Prerequisites like Xcode and iOS versions? -->
